...
(
  ...
  param_user VARCHAR2(50) not null,
  jpa_user VARCHAR2(50)
) tablespace TESTTBLSPC storage (initial 5M maxextents unlimited);
...
comment on column JRU_TBL.param_user is 'User from parameter';
...
(
  ...
  client_identifier VARCHAR2(50) not null,
...
comment on column JRU_JRNL.ora_user  is 'Oracle level user (fill by trigger)';
comment on column JRU_JRNL.client_identifier  is 'JPA level user (fill by trigger)';
